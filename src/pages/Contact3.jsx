    ...
    <div className={`contact-page ${isLoaded ? 'loaded' : ''}`}>
      ...
      <section ref={heroRef} className="hero-section">
        ...
        <div className="hero-content">
          <h1 className="hero-title">Book Cinematography Specialist</h1>
          <p className="hero-subtitle">
            Wedding Films & Videography | 7+ Years Experience | Cinematic Love Stories with Stunning Visuals
          </p>
        </div>
      </section>
        ...
        <div className="container">
          <div className="contact-grid">
            ...
            <div className="contact-form-section">
              <h2>Book Cinematography Specialist</h2>
              <p>Creating cinematic wedding films. Fill out the form and we'll bring your love story to life within 24 hours.</p>
            ...
            <div className="contact-info-section">
              <h2>Contact Cinematography Specialist</h2>
              <p style={{marginBottom: '30px', color: 'var(--text-muted)'}}>Creating cinematic wedding films that tell your love story</p>
              ...
              <div className="contact-info">
                <div className="contact-item">
                  ...
                  <div className="contact-details">
                    <h3>Phone</h3>
                    <p>
                      <a href="tel:+94767890123">+94 76 789 0123</a>
                    </p>
                  </div>
                </div>
                ...
                <div className="contact-item">
                  ...
                  <div className="contact-details">
                    <h3>Email</h3>
                    <p>
                      <a href="mailto:cinema@solidweddings.lk">
                        cinema@solidweddings.lk
                      </a>
                    </p>
                  </div>
                </div>
