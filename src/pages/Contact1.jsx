    ...
    <div className={`contact-page ${isLoaded ? 'loaded' : ''}`}>
      ...
      <section ref={heroRef} className="hero-section">
        ...
        <div className="hero-content">
          <h1 className="hero-title">Book Solid Weddings Team</h1>
          <p className="hero-subtitle">
            Complete Wedding Coverage | 10+ Years Experience | Professional Team Excellence
          </p>
        </div>
      </section>
        ...
        <div className="container">
          <div className="contact-grid">
            ...
            <div className="contact-form-section">
              <h2>Book Solid Weddings Team</h2>
              <p>Complete wedding coverage with our professional team. Fill out the form and we'll get back to you within 24 hours.</p>
            ...
            <div className="contact-info-section">
              <h2>Contact Solid Weddings Team</h2>
              <p style={{marginBottom: '30px', color: 'var(--text-muted)'}}>Professional team for complete wedding coverage</p>
              ...
              <div className="contact-info">
                ...
                <div className="contact-item">
                  ...
                  <div className="contact-details">
                    <h3>Email</h3>
                    <p>
                      <a href="mailto:solidteam@solidweddings.lk">
                        solidteam@solidweddings.lk
                      </a>
                    </p>
                  </div>
                </div>
