    ...
    <div className={`contact-page ${isLoaded ? 'loaded' : ''}`}>
      ...
      <section ref={heroRef} className="hero-section">
        ...
        <div className="hero-content">
          <h1 className="hero-title">Book Lead Photographer</h1>
          <p className="hero-subtitle">
            Candid & Artistic Photography | 8+ Years Experience | Authentic Emotions & Timeless Memories
          </p>
        </div>
      </section>
        ...
        <div className="container">
          <div className="contact-grid">
            ...
            <div className="contact-form-section">
              <h2>Book Lead Photographer</h2>
              <p>Expert in candid & artistic photography. Fill out the form and we'll discuss your vision within 24 hours.</p>
            ...
            <div className="contact-info-section">
              <h2>Contact Lead Photographer</h2>
              <p style={{marginBottom: '30px', color: 'var(--text-muted)'}}>Expert in candid and artistic wedding photography</p>
              ...
              <div className="contact-info">
                ...
                <div className="contact-item">
                  ...
                  <div className="contact-details">
                    <h3>Email</h3>
                    <p>
                      <a href="mailto:lead@solidweddings.lk">
                        lead@solidweddings.lk
                      </a>
                    </p>
                  </div>
                </div>
